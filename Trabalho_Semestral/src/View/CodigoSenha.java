 ...
 * @author PC
 */
public class CodigoSenha extends javax.swing.JFrame {

    /**
     * Creates new form CodigoSenha
     */
    public CodigoSenha() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 380, 90, -1));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 40, 360, 500));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CodigoSenha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CodigoSenha().setVisible(true);
            }
        });
    }
